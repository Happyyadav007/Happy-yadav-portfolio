...
const DUMMY_USER_DATA = {
  ...
  experience: [
    {
      ...
      description: [
        "Spearheaded the development and optimization of backend APIs using Node.js, Express.js, and MongoDB, leading to a 20% improvement in data processing speed.",
        "Engineered and implemented secure authentication (JWT) and role-based access control (RBAC) systems for comprehensive user management and data protection.",
        "Constructed dynamic and responsive React.js frontend components and pages with Tailwind CSS, enhancing user engagement and achieving a 95% Lighthouse performance score.",
        "Seamlessly integrated frontend applications with backend services, enabling real-time data synchronization and significantly improving overall system efficiency and user experience."
      ],
  ...
  projects: [ // Keeping existing projects, can add more details if needed
    {
      ...
      shortDescription: "Robust backend for an Ed-Tech platform supporting diverse user roles and functionalities.",
    ...
    },
    {
      ...
      shortDescription: "MERN stack application leveraging Google Gemini AI for intelligent email composition.",
    ...
    },
    {
      ...
      shortDescription: "Responsive web application providing real-time weather information using OpenWeatherMap API.",
    ...
    },
     {
      ...
      category: "Backend Development",
      shortDescription: "Secure and scalable backend system for user authentication and session management.",
  ...
  services: [ // No change from previous
    {
      ...
      description: "Building complete web applications from front-end to back-end using the MERN stack (MongoDB, Express.js, React, Node.js). I focus on creating responsive, scalable, and maintainable solutions tailored to your needs.",
    ...
    },
    {
      ...
      description: "Crafting beautiful, interactive, and user-friendly interfaces with React.js and modern CSS frameworks like Tailwind CSS. Ensuring optimal performance and accessibility across all devices.",
    ...
    },
    {
      ...
      description: "Designing and developing robust, secure, and scalable RESTful APIs using Node.js and Express.js. Integrating with databases like MongoDB and ensuring efficient data management.",
    ...
    },
    {
      ...
      description: "Working with MongoDB and MySQL to design database schemas, optimize queries, and ensure data integrity and security for your applications.",
  ...
  education: [ // No change from previous
    {
      ...
      period: "2022 - 2024",
      details: "Focused on advanced software development, database management, web technologies, and data structures & algorithms."
    },
    {
      id: "edu2",
  ...
  achievements: [ // Expanded for a dedicated page/section
    ...
    { id: "ach4", name: "Top Performer - College Hackathon", issuer: "GNIOT", date: "Mar 2023", description: "Led a team to develop an innovative solution for [Problem Statement], securing a top 3 position among 50+ teams." },
  ],
  testimonials: [
    {
      id: "test1",
      quote: "Happy is an incredibly talented and dedicated developer. His problem-solving skills and commitment to quality are truly commendable. He was a valuable asset to our project.",
      author: "Dr. Emily Carter",
      role: "Project Lead, Sankhyana Consultancy (Dummy)",
      avatarUrl: "https://placehold.co/100x100/0F172A/E0E7FF?text=EC&font=inter"
    },
    {
      id: "test2",
      quote: "Working with Happy was a fantastic experience. He's a quick learner, highly proficient in MERN stack, and always brings a positive attitude. His contributions significantly improved our application's performance.",
      author: "John B. Anderson",
      role: "Senior Developer, Tech Solutions Inc. (Dummy)",
      avatarUrl: "https://placehold.co/100x100/0F172A/E0E7FF?text=JA&font=inter"
    },
    {
      id: "test3",
      quote: "Happy's ability to quickly grasp complex requirements and translate them into clean, efficient code is impressive. He's a great team player and a joy to collaborate with.",
      author: "Priya Sharma",
      role: "Product Manager, Innovate Hub (Dummy)",
      avatarUrl: "https://placehold.co/100x100/0F172A/E0E7FF?text=PS&font=inter"
    }
  ]
};
